        ...
        <div class="row gy-5">
            ...
            <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
              <div class="service-item">
                <div class="img">
                  <img src="/images/{{ $service->image }}" class="img-fluid" alt="" width="456">
                </div>
            ...
            <form action="{{ route('send.message') }}" method="post" class="php-email-form">
              ...
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="text" name="name" class="form-control" id="name" placeholder="{{ __('Votre nom') }}" required>
                </div>
                <div class="col-md-6 form-group mt-3 mt-md-0">
                  <input type="email" class="form-control" name="email" id="email" placeholder="{{ __('Votre email') }}" required>
                </div>
              </div>
              <div class="form-group mt-3">
                <input type="text" class="form-control" name="subject" id="subject" placeholder="{{ __('Sujet') }}">
              </div>
              <div class="form-group mt-3">
              ...
              <div class="text-center"><button type="submit">{{ __('Envoyer Message') }}</button></div>
            </form>
