          ...
          <div class="row gx-4">
            <div class="col-auto">
              <div class="avatar avatar-xl position-relative">
                  @if (Auth::user()->image)
                      <img src="/images/{{ $user->image }}" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
                  @else
            ...
            <!-- Second Nav-menu -->
              <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
                  ...
                  <ul class="nav nav-pills nav-fill p-1">
                    @if ($edit)
                        <li class="nav-item">
                            <a data-toggle="pill" href="/myProfile" class="nav-link mb-0 px-0 py-1 active d-flex align-items-center justify-content-center">
      ...
      <div class="row">
          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0">Mon profil</p>
                @if (!$edit)
                <a href="/edit/myProfile" class="btn btn-primary btn-sm ms-auto">Modifier</a>
                @endif
              </div>
            </div>
            <form action="{{ route('update.my.profile') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        <label for="first_name" class="form-control-label">Prénoms</label>
                        <input id="first_name" class="form-control" type="text" value="{{ $user->first_name }}" required @if (!$edit) disabled @endif name="first_name">
                    </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
                        <label for="last_name" class="form-control-label">Noms</label>
                        <input id="last_name" class="form-control" type="text" value="{{ $user->last_name }}"  required @if (!$edit) disabled @endif required name="last_name">
                    </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
                        <label for="phone" class="form-control-label">Téléphone</label>
                        <input id="phone" class="form-control" type="text" value="{{ $user->phone }}"  required @if (!$edit) disabled @endif required name="phone">
                    </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
                        <label for="country" class="form-control-label">Pays</label>
                        <input id="country" class="form-control" type="text" value="{{ $user->country }}"  required @if (!$edit) disabled @endif required name="country">
                    </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
                        <label for="email" class="form-control-label">Email</label>
                        <input id="email" class="form-control" type="email" value="{{ $user->email }}"  required @if (!$edit) disabled @endif required name="email">
                    </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
        ...
        <div class="col-md-4">
          <div class="card card-profile">
            <img src="/assets/admin/assets/img/bg-profile.jpg" alt="Image placeholder" class="card-img-top">
                ...
                <div class="col">
                  <div class="d-flex justify-content-center">
                    <div class="d-grid text-center">
                      <span class="text-lg font-weight-bolder">{{ $blogs->count() }}</span>
                      <span class="text-sm opacity-8">Blogs</span>
                    </div>
                    <div class="d-grid text-center mx-4">
                      <span class="text-lg font-weight-bolder">{{ $services->count() }}</span>
