          ...
          <div class="col-12">
            <div class="card mb-4">
              <div class="card-header pb-0">
                <h6>Les Utilisateurs inscrits</h6>
              </div>
                  ...
                  <table class="table align-items-center justify-content-center mb-0">
                    <thead>
                      <tr>
                        ...
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Photo & Prénoms</th>
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Noms</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex px-2">
                                    <div>
                                        @if ($user->image)
                                            <img src="/images/{{ $user->image }}" class="avatar avatar-sm rounded-circle me-2" alt="spotify">
                                        @else
                                            <i class="ni ni-single-02 text-dark text-sm opacity-10"></i>
                                        @endif
                                    </div>
                            ...
                            <td>
                                <span class="text-xs font-weight-bold">Administrateur</span>
                            </td>
                            <td class="align-middle text-center">
                                <div class="ms-auto text-end">
                                  <a class="btn btn-link text-dark px-3 mb-0" href="detail/user/{{ $user->id }}"><i class="ni ni-bullet-list-67 text-dark text-sm opacity-10"></i>Details</a>
                                  @if (Auth::user()->id != $user->id)
                                    <a class="btn btn-link text-dark px-3 mb-0" href="/user/isnot/admin/{{ $user->id }}"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Enlever Admin</a>
                                  @endif
                            </div>
                            </td>
                        </tr>
                  ...
                  <table class="table align-items-center justify-content-center mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            {{-- <td>
                                <span class="text-xs font-weight-bold">{{ $user->updated_at }}</span>
                            </td> --}}
                            <td class="align-middle text-center">
                                <div class="ms-auto text-end">
                                  <a class="btn btn-link text-dark px-3 mb-0" href="detail/user/{{ $user->id }}"><i class="ni ni-bullet-list-67 text-dark text-sm opacity-10"></i>Details</a>
                                </div>
                                <a class="btn btn-link text-dark px-3 mb-0" href="/user/is/admin/{{ $user->id }}"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Ajouter Admin</a>
                            </td>
                        </tr>
                        @endif
                        @endforeach
