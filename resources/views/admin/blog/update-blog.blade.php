                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input class="form-control" value="{{ $blog->title }}" type="text" name="title" id="title" placeholder="Entrer un titre ici..." required>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" name="service_id" id="service_id" placeholder="Entrer un titre ici...">
                            @foreach ($services as $service)
                                <option value="{{ $service->id }}" @if ($service->id == $blog->service_id)@selected(true)@endif>{{ $service->title }}</option>
                            @endforeach
                          </select>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <textarea class="form-control" name="description" id="description" cols="30" rows="3" placeholder="Entrer la description ici..." required>{{ $blog->description }}</textarea>
                        </div>
                      </div>
                      <div class="card-header pb-0">
                        <div class="d-flex align-items-center">
