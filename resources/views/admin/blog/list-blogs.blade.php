                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex px-2">
                                    <div>
                                    <img src="/images/{{ $blog->image }}" class="avatar avatar-sm rounded-circle me-2" alt="spotify">
                                    </div>
                                    <div class="my-auto">
                            ...
                            <td>
                                @foreach ($services as $service)
                                    @if ($service->id == $blog->service_id)
                                        <p class="text-sm font-weight-bold mb-0">{{ $service->title }}</p>
                                    @endif
                                @endforeach
                            </td>
                            {{-- <td>
                                <span class="text-xs font-weight-bold">{{ $blog->updated_at }}</span>
                            </td> --}}
                                    ...
                                    <div class="modal fade" id="deleteModal{{ $blog->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <h5 class="modal-title font-weight-normal" id="exampleModalLabel">Supprimer blog</h5>
