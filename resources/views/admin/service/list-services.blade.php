                        ...
                        <tr>
                            <td>
                                <div class="d-flex px-2">
                                    <div>
                                    <img src="/images/{{ $service->image }}" class="avatar avatar-sm rounded-circle me-2" alt="spotify">
                                    </div>
                                    <div class="my-auto">
                            ...
                            <td>
                                <p class="text-sm font-weight-bold mb-0">{{ $service->description }}</p>
                            </td>
                            {{-- <td>
                                <span class="text-xs font-weight-bold">{{ $service->updated_at }}</span>
                            </td> --}}
                                    ...
                                    <div class="modal fade" id="deleteModal{{ $service->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <h5 class="modal-title font-weight-normal" id="exampleModalLabel">Supprimer service</h5>
          ...
          <div class="row align-items-center justify-content-lg-between">
            ...
            <div class="col-lg-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                ...
                <li class="nav-item">
                  <a href="/services" class="nav-link text-muted" target="_blank">services</a>
                </li>
                <li class="nav-item">
